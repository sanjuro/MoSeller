module EsetHelper
  ...
  @@ESET_USERNAME = AppConfig.instance.eset_username
  @@ESET_PASSWORD =  AppConfig.instance.eset_password
  ...
  def create_license(transaction_options)
    # Setting up a Savon::Client representing a SOAP service.
    client = Savon::Client.new do
