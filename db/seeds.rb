...
ActiveRecord::Base.transaction do
  ...
  if Location.count == 0
    location = Location.new :client_id => 1, :address1 => "Blue House", :address2 => "23 Jump Street", :address3 => "Jumpville", :address4 => "Cape Town", :latitude => 0, :logitude => 0, :location_type_id => 1
    location.id = 1
    location.save!
  end
  ...
  if Supplier.count == 0
    supplier1 = Supplier.new :registered_name => "ESET", :email_address => "info@eset.co.za", :url => "www.eset.co.za", :token => "12as2e222sa3jn3j"
    supplier1.id = 1
    supplier1.save!
    
    supplier2 = Supplier.new :registered_name => "Freepaid", :email_address => "info@freepaid.co.za", :url => "www.freepaid.co.za", :token => "32zs2e343sa3jn3j"
    supplier2.id = 2
    supplier2.save!
    
    supplier3 = Supplier.new :registered_name => "Blizzard", :email_address => "info@blizzard.co.za", :url => "www.blizzard.co.za", :token => "12as2e333sa3jn3j"
    supplier3.id = 3
    supplier3.save!
  end
  ...
  if Productsource.count == 0
    ...
    productsource2 = Productsource.new :source_name => "Freepaid", :service_type_id => 1, :supplier_id => 2
    productsource2.id = 2
    productsource2.save!
  end
